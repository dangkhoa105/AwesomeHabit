...
const handleNotify = async (navigation) => {
  ...
  PushNotification.configure({
    ...
    onNotification: function (notification) {
      if (Platform.OS === 'ios') {
        handleTouch(notification, navigation)
        // (required) Called when a remote is received or opened, or local notification is opened
...
const showForeground = ({ notification }) => {
  ...
  PushNotification.localNotificationSchedule({
    ...
    bigPictureUrl: 'ic_notification', // (optional) default: undefined
...
export { getDeviceToken, requestUserPermission, handleNotify, showForeground, showForegroundIOS }
